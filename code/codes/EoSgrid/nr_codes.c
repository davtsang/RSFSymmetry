//module for codes from numerical recipies in c (Press, William H. Numerical Recipes in C : the Art of Scientific Computing. 2nd ed., Cambridge University Press, 1992)
#include <stdio.h>
#include <math.h>
#include <stdlib.h>
#define TINY 1.0E-30
