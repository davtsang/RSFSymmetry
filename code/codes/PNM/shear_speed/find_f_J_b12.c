...
void main(int argc, char *argv[])
{
  ...
  FILE *in_file=fopen("all_ctav_2.txt","r"); 
...
//  }printf("\n");
  ...
  if (ffound>2000){  //(((currently set to use linear splines, seems to be too difficult for cubic to manage)))
    for (i=0;i<ffound;i++){
