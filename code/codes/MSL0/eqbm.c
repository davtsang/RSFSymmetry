...
//smooths the input array so that cubic splines won't fail too badly (not used, better to use linear interpolation instead)
...
//shear modulus -> Strohmayer 1991 (unused, mu provided in EoS files)
...
//derivative of logp(logrho) (unused, more acurate adiabatic index provided in EoS files)
